...
- 🔐 Кибербезопасность для веб-приложений

## 📝 Последние статьи на Dev.to

<!-- BLOG-POST-LIST:START -->
- [Как я использовал ASP.NET Core для создания высокопроизводительного API](https://dev.to)
- [Лучшие практики TypeScript в 2024 году](https://dev.to)
- [Рефакторинг React-приложений для повышения производительности](https://dev.to)
<!-- BLOG-POST-LIST:END -->

## 🎧 Сейчас слушаю

<div align="center">
  <img src="https://spotify-github-profile.vercel.app/api/view?uid=31urljdxkodyhb5eyxvzb3ysbtgq&cover_image=true&theme=novatorem" alt="Spotify" />
</div>

## ⚡ Моя статистика кодинга
...
## 💬 Любимые цитаты о программировании

> "Программирование — это не о том, что ты знаешь, а о том, что ты можешь выяснить." — Chris Pine
